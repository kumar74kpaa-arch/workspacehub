      ...
      <main className="flex-1">
        <div className="container py-12 md:py-24 max-w-4xl mx-auto">
          <div className="prose lg:prose-lg">
            ...
            <p>
              Welcome to Workspace Hub. By accessing our premises or using our services, you agree to comply with and be bound by the following terms and conditions. Please review them carefully.
            </p>
            ...
            <ul>
              <li><strong>Parking:</strong> On-site parking is available but is entirely at the vehicle owner's risk. Workspace Hub is not liable for any theft, damage, or loss.</li>
