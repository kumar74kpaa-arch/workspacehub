...
export const officeLayouts: Record<string, OfficeLayout> = {
    'banyan': {
        ...
        hotspots: [
            // Meeting Room
            { id: 'BANYAN-MR-09', type: 'meeting-room', top: '15.5%', left: '14.5%', width: '20%', height: '35%', label: 'Boardroom (9+3)' },
            // Stairs (Utility)
            ...
            { id: 'BANYAN-WS-05', type: 'workstation', top: '18%', left: '49.5%', width: '5%', height: '8%' },
            { id: 'BANYAN-WS-06', type: 'workstation', top: '28%', left: '49.5%', width: '5%', height: '8%' },
            { id: 'BANYAN-WS-07', type: 'workstation', top: '18%', left: '57.5%', width: '5%', height: '8%' },
            { id: 'BANYAN-WS-08', type: 'workstation', top: '28%', left: '57.5%', width: '5%', height: '8%' },
            { id: 'BANYAN-WS-09', type: 'workstation', top: '18%', left: '65.5%', width: '5%', height: '8%' },
            { id: 'BANYAN-WS-10', type: 'workstation', top: '28%', left: '65.5%', width: '5%', height: '8%' },
            { id: 'BANYAN-WS-11', type: 'workstation', top: '58%', left: '40.5%', width: '5%', height: '8%' },
            { id: 'BANYAN-WS-12', type: 'workstation', top: '68%', left: '40.5%', width: '5%', height: '8%' },
            // Right Side
