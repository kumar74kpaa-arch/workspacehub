...
export const seatMap: SeatHotspot[] = [
  // Meeting Room
  { id: 'MR-12', type: 'meeting-room', top: '15.5%', left: '4.5%', width: '20%', height: '35%' },

  // Stairs (Utility)
  { id: 'Stairs', type: 'utility', top: '56%', left: '4.5%', width: '15%', height: '27%', disabled: true },
  ...
  // Right Side
  { id: 'Breakout', type: 'breakout', top: '18%', left: '77%', width: '18%', height: '18%', label: 'Breakout Area' },
  { id: 'Restroom', type: 'utility', top: '40%', left: '79%', width: '12%', height: '20%', disabled: true },
  { id: 'Pantry', type: 'utility', top: '68%', left: '76%', width: '10%', height: '15%', disabled: true },
];
